defmodule Pento.SurveyTest do
  ...
  describe "demographics" do
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      valid_attrs = %{gender: "female", year_of_birth: 2001, user_id: user_fixture().id}
    ...
    test "update_demographic/2 with valid data updates the demographic" do
      demographic = demographic_fixture()
      update_attrs = %{gender: "female", year_of_birth: 2002}
  ...
  describe "ratings" do
    ...
    test "create_rating/1 with valid data creates a rating" do
      valid_attrs = %{stars: 4, product_id: product_fixture().id, user_id: user_fixture().id}
