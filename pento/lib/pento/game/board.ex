defmodule Pento.Game.Board do
  ...
  def puzzles(), do: ~w{default wide widest medium tiny small ball donut}a
  ...
  def new(palette, points, hole \\ []), do: %__MODULE__{palette: palette(palette), points: (points -- hole)}
